  ...
  if(isset($_GET['Afficher'])) {
    if (isset($_GET['objetifGestion']) AND isset($_GET['typeLog']) AND isset($_GET['surface']) AND isset($_GET['ville'])) {
      if (!empty($_GET['objetifGestion']) AND !empty($_GET['typeLog']) AND !empty($_GET['surface']) AND !empty($_GET['ville'])) {
        ...
        $req=$con->prepare('SELECT * FROM logement WHERE typeLog LIKE "%'.$recherche1.'%" AND surface LIKE "%'.$recherche0.'%" AND objetifGestion LIKE "%'.$recherche2.'%" AND prix LIKE "%'.$recherche5.'%" AND objetifGestion = "Location" ORDER BY n_Log DESC');       
    ...
    <a name="ancre"></a><div style="margin-left:50px">
      ...
      <tr style="background-color: #f8f6ff;">
        <td class="col-md-5">
          ...
          <p class="lead">
            <h3 class="featurette-heading fw-normal lh-1">Prix : <span class="text-muted"><?php echo ($recherche5); ?> FCFA/mois.</span></h3>
...
<?php if (@$valider!="oui" && @$valide!="non" && @$valide!="ou") { ?>
<a name="ancre"></a>
<div><h3 style="margin-left: 50px;">A louer</h3></div>
<div style="margin-left:50px">
    
      <strong><?=Compter2();?> Annonce(s) trouvée(s)</strong><br>
      ...
      <tr style="background-color: #f8f6ff;">
        <td class="col-md-5">
          ...
          <p class="lead">
            ...
            <h3 class="featurette-heading fw-normal lh-1">Prix : <span class="text-muted"><?=$key->prix?> FCFA/mois.</span></h3>

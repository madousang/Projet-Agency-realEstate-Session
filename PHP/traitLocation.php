...
<div id="un2">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page"><a href="location.php">Location</a></li>
...
<a name="ancre"></a><div style="margin-left:50px">
  ...
  <?php } ?>
<?php if (@$valider!="oui") {
    exit("Veillez remplir tous les champ du formulaire.");
   } ?>
